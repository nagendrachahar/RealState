...
export class BankComponent implements OnInit {
  ...
  public FillForm(Id: number) {
    ...
    this.service.GetOneBank(Id)
        .subscribe((data) => {
          ...
          this.Bankform.controls['BankId'].setValue(data[0].BankId);
          this.Bankform.controls['BankName'].setValue(data[0].BankName);
    ...
    public save() {
      this.service.SaveBank(this.Bankform.value)
            .subscribe((data) => {
  ...
  get BankId() { return this.Bankform.get('BankId'); }
